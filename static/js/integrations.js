...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('brakeman editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('brakeman item error', item)
        ...
        initialState: () => ({
            ...
            pluginName: 'security_scanner_brakeman',
...
register_component('brakemanIntegration', brakemanIntegration)
